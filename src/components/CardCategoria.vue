...
export default{
    props: {
      categoria: {type: Object as PropType<TCategoria>, required: true}
    },
    components: {Tag, IngredienteSelecionavel},
    methods: {
      addIngredient(event: string){  // Or simply what is already on the template
        this.$emit("addIngredient", event);  // This just sends whatever was passed back to the parent
      }
    },
